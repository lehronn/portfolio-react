          ...
          <div className="container">
            <div className="row">
              <div className="col-12 text-light">
                ...
                <br/><br/>
                <a className="text-light btn btn-primary card-link float-right" href="http://stomski.pl/others/cv.pdf"><i className="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;Moje CV</a>
              </div>
            </div>
          </div>
        </div>
