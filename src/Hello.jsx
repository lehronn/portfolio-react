          ...
          <div className="container">
            <div className="row">
              <div className="col-12 text-light">
                ...
                <br/><br/>
                <a className="text-light btn btn-primary card-link float-right btn-hello" target="_blank" href="http://stomski.pl/others/kodilla.jpg"><i className="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;Zaświadczenie o ukończeniu kursu Kodilli</a>
                <a className="text-light btn btn-primary card-link float-right btn-hello" target="_blank" href="http://stomski.pl/others/cv.pdf"><i className="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;Moje CV</a>
              </div>
            </div>
          </div>
        </div>
